...
<div className="glass-card rounded-xl p-md shadow-2xl">
{error && (
...
<input className="input-field w-full pl-10 pr-4 py-3 rounded-lg text-on-surface font-body-md text-body-md placeholder-on-surface-variant/50 focus:ring-0" id="email" name="email" placeholder="admin@neovault.io" required type="email" />
</div>
</div>
...
<input className="input-field w-full pl-10 pr-10 py-3 rounded-lg text-on-surface font-body-md text-body-md placeholder-on-surface-variant/50 focus:ring-0" id="password" name="password" placeholder="••••••••" required type={showPassword ? "text" : "password"} />
...
<div className="pt-2">
<button className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg glow-btn font-label-md text-label-md text-on-primary-fixed uppercase tracking-wider font-bold" type="submit">
