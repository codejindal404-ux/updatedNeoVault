            ...
            <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] gap-10 relative z-10">
              <div className="flex flex-col items-center border-r border-white/5 pr-0 md:pr-10">
                <div className="relative group cursor-pointer mb-6">
                  <div className="w-40 h-40 rounded-full overflow-hidden border-2 border-primary/30 group-hover:border-primary transition-colors duration-300 relative">
                    <img className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBhmywtzBEC35K5eaWngr1kF8b-ARW4SLu7xfKyXzObIadxCOpsuK7qJ7lAKU6n5RW3JVfxbrhzpVBYbRXphD8A5qPrdmVeLKOMDBwaUdD4R9CRZLyPaGmC7diuLwUnGWk4AS33ye1cwWFIqaPnMnCuyM2BaS4UCFk1k2tVYJff_QTfJPi_DyvDldQxIObt8LFh30SCBRv5ZBQkcKgDaTZivfD79LDZN3PyLhzaeR2ULPfvhPNIIIYyVrDOaUeuLgfvYLDEBQAlXmWo" />
                ...
                <h3 className="font-headline-md text-headline-md text-on-surface mb-1 text-center truncate max-w-full">{displayName}</h3>
                <p className="font-label-caps text-label-caps text-primary/70 mb-8 text-center">
                  Role: {userData?.is_admin ? 'Admin' : 'Standard User'}
                </p>
              </div>
              ...
              <div className="space-y-10">
                <section>
                  ...
                  <form className="space-y-4">
                    <div>
                      ...
                      <input 
                        className="w-full input-dark rounded-md px-4 py-2 font-body-md text-on-surface focus:ring-0 opacity-70 cursor-not-allowed" 
                        type="email" 
                ...
                <section>
                  ...
                  <form className="space-y-4">
                    {/* TODO: connect to change-password endpoint if it exists in backend, otherwise this is non-functional */}
                    <div>
                      <label className="block font-label-md text-label-md text-on-surface-variant mb-1">Current Password</label>
                      <input className="w-full input-dark rounded-md px-4 py-2 font-body-md text-on-surface focus:ring-0 opacity-50 cursor-not-allowed" placeholder="••••••••" type="password" disabled />
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block font-label-md text-label-md text-on-surface-variant mb-1">New Password</label>
                        <input className="w-full input-dark rounded-md px-4 py-2 font-body-md text-on-surface focus:ring-0 opacity-50 cursor-not-allowed" type="password" disabled />
                      </div>
                      <div>
                    ...
                    <div className="flex justify-end pt-2">
                      <button className="px-6 py-2 rounded-lg border border-white/10 text-on-surface-variant font-label-md text-label-md opacity-50 cursor-not-allowed" type="button" disabled>Update Key</button>
                    </div>
                  </form>
                </section>
                ...
                <section className="mt-12 pt-8 border-t border-error/20">
                  ...
                  <div className="bg-error/5 border border-error/10 rounded-lg p-4 space-y-4">
                    <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                      ...
                      <button className="px-4 py-2 rounded-lg border border-white/10 text-on-surface font-label-md text-label-md whitespace-nowrap opacity-50 cursor-not-allowed" disabled>Export .CSV</button>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                      ...
                      {/* TODO: not yet implemented in backend */}
                      <button className="px-4 py-2 rounded-lg bg-error/10 text-error border border-error/30 font-label-md text-label-md whitespace-nowrap opacity-50 cursor-not-allowed" disabled>Delete Account</button>
                    </div>
                  </div>
                </section>
              </div>
