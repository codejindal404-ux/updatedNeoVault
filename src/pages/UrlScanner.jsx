...
<img alt="User Avatar" className="w-full h-full object-cover" data-alt="A macro photography shot of a high-tech glowing blue data core, symbolizing digital identity. Dark minimalist aesthetic." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAV3D7KoozMwrdFazSF00sVQTKXKoLuzqkOrqkwoQsePLGZb4gTimLQLed4hZiBqOd1eu47YapdmDqbbUppAkdwb8tR6S-PynpjZlbmigSuOEoLI3FaggJNaJSVXK2tzLSLGS5V9mPXDAdiA760nn--_IFnwHhAVkqb7rkL6q5P3rmvCNAZDDkLEy2FKtLfiY6N2wWzYX78CApsHuGzQesBe0qW3D9CPdNS0z2YcJaIzsIyGI9jV_Hr0WF4v1oYf5fpB89VM6X5oCcs" />
</div>
</div>
</header>
...
<input className="flex-1 bg-transparent border-none outline-none text-on-surface font-body-lg text-body-lg placeholder-on-surface-variant/50 focus:ring-0" placeholder="https://example.com/login" type="text" value="https://suspicious-login-portal-v2.net/auth" />
<button className="glow-btn-primary px-8 py-4 rounded-lg font-body-md text-body-md font-semibold text-surface-container-lowest flex items-center gap-2">
...
<svg className="circular-chart text-error" viewbox="0 0 36 36">
<path className="circle-bg" d="M18 2.0845
                                a 15.9155 15.9155 0 0 1 0 31.831
                                a 15.9155 15.9155 0 0 1 0 -31.831"></path>
<path className="circle stroke-error" d="M18 2.0845
                                a 15.9155 15.9155 0 0 1 0 31.831
                                a 15.9155 15.9155 0 0 1 0 -31.831" strokeDasharray="82, 100"></path>
<text className="percentage font-headline-xl text-headline-xl fill-error font-bold" x="18" y="20.35">82</text>
<text className="fill-on-surface-variant font-label-caps text-[6px] uppercase tracking-wider text-anchor-middle" x="18" y="26">High Risk</text>
</svg>
</div>

<div className="flex items-center gap-2 px-6 py-2 rounded-full bg-error/10 border border-error/20 z-10 shadow-[0_0_15px_rgba(255,180,171,0.2)]">
<span className="material-symbols-outlined text-error text-sm" data-icon="warning" data-weight="fill" style={{fontVariationSettings: '\'FILL\' 1'}}>warning</span>
<span className="font-label-caps text-label-caps text-error">DANGER DETECTED</span>
</div>
</div>
...
<p className="font-body-md text-body-md text-on-surface truncate max-w-xs text-error">suspicious-login-portal-v2.net</p>
</div>
<div className="h-8 w-px bg-white/10 mx-4"></div>
<div>
<p className="font-label-caps text-label-caps text-on-surface-variant mb-1">IP Address</p>
<p className="font-body-md text-body-md text-on-surface font-mono">192.168.1.245</p>
</div>
<div className="h-8 w-px bg-white/10 mx-4"></div>
<div>
<p className="font-label-caps text-label-caps text-on-surface-variant mb-1">Scan Time</p>
<p className="font-body-md text-body-md text-on-surface">2s ago</p>
</div>
</div>
...
<span className="material-symbols-outlined text-tertiary-fixed text-sm" data-icon="check" data-weight="fill" style={{fontVariationSettings: '\'FILL\' 1'}}>check</span>
</div>
<div>
<p className="font-body-md text-body-md text-on-surface">HTTPS Enabled</p>
<p className="font-label-md text-label-md text-tertiary-fixed">Valid Certificate</p>
</div>
</div>

<div className="flex items-center gap-4 p-3 rounded-lg bg-error/10 border border-error/20 relative overflow-hidden group">
<div className="absolute inset-0 bg-gradient-to-r from-error/0 to-error/5 group-hover:to-error/10 transition-colors"></div>
<div className="w-8 h-8 rounded-full bg-error/20 flex items-center justify-center relative z-10">
<span className="material-symbols-outlined text-error text-sm" data-icon="phishing">phishing</span>
</div>
<div className="relative z-10">
<p className="font-body-md text-body-md text-on-surface">Phishing Signatures</p>
<p className="font-label-md text-label-md text-error">Match found in DB</p>
</div>
</div>

<div className="flex items-center gap-4 p-3 rounded-lg bg-secondary/10 border border-secondary/20">
<div className="w-8 h-8 rounded-full bg-secondary/20 flex items-center justify-center">
<span className="material-symbols-outlined text-secondary text-sm" data-icon="route">route</span>
</div>
<div>
<p className="font-body-md text-body-md text-on-surface">Suspicious Redirects</p>
<p className="font-label-md text-label-md text-secondary">3 hops detected</p>
</div>
</div>

<div className="flex items-center gap-4 p-3 rounded-lg bg-white/5 border border-white/5">
<div className="w-8 h-8 rounded-full bg-tertiary-fixed-dim/20 flex items-center justify-center">
<span className="material-symbols-outlined text-tertiary-fixed text-sm" data-icon="bug_report">bug_report</span>
</div>
<div>
<p className="font-body-md text-body-md text-on-surface">Malware Scan</p>
<p className="font-label-md text-label-md text-tertiary-fixed">Clean</p>
</div>
</div>

<div className="flex items-center gap-4 p-3 rounded-lg bg-white/5 border border-white/5">
<div className="w-8 h-8 rounded-full bg-tertiary-fixed-dim/20 flex items-center justify-center">
<span className="material-symbols-outlined text-tertiary-fixed text-sm" data-icon="block">block</span>
</div>
<div>
<p className="font-body-md text-body-md text-on-surface">Blacklist Check</p>
<p className="font-label-md text-label-md text-tertiary-fixed">Not Listed</p>
</div>
</div>

<div className="flex items-center gap-4 p-3 rounded-lg bg-secondary/10 border border-secondary/20">
<div className="w-8 h-8 rounded-full bg-secondary/20 flex items-center justify-center">
<span className="material-symbols-outlined text-secondary text-sm" data-icon="domain_disabled">domain_disabled</span>
</div>
<div>
<p className="font-body-md text-body-md text-on-surface">Domain Age</p>
<p className="font-label-md text-label-md text-secondary">Created 2 days ago</p>
</div>
</div>
</div>
</div>
